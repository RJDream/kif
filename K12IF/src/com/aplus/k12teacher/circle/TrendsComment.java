 ...
 * ------------------------------------------------------------
 */
@AutoInterface(id = "IF01050003", versions = "V1000", des = "老师发表评论/回复接口")
public class TrendsComment extends TransactionInterfaceBase {
	...
	// 评论角色为老师：01
	final static String COMMENT_ROLE_TEACHER = "01";
	...
	public String execute(IFRequestMessage tmb) throws Exception {
		...
		// 评论人id/回复ID/圈子ID/班级ID/学校ID/评论内容/评论角色
		...
		try {
			...
			Object[] params = new Object[]{uuid ,replyId,sclassId,commentUserId,publishRole,content,circleId,schoolId};
