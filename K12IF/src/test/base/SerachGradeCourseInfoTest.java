...
public class SerachGradeCourseInfoTest extends BaseInterfaceTest {
	...
	public void test() throws Exception {
		// 准备加密业务数据
		String data = "{header:{osType:'ios'},data:{schoolId:'402981ed50133c870150133f31a50000'}}";
