...
public class SerachNoticeTest extends BaseInterfaceTest {
	...
	public void test() throws Exception {
		// 准备加密业务数据
		String data = "{header:{osType:'ios'},data:{pager:{page:'2',pageRecorders:'2'},teacherId:'402981ed50133c870150133f35300002',schoolId:'402981ed50133c870150133f31a50000'}}";
