package test.com.aplus.k12teacher.user;
...
public class TeacherLoginTest extends BaseInterfaceTest {
	...
	public void test() throws Exception {
		// 准备加密业务数据
		String data = "{header:{osType:'ios'},data:{username:'15328182562',password:'0024'}}";
