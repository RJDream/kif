 ...
 * ------------------------------------------------------------
 */
public class SerachSingleGradeRankingTest extends BaseInterfaceTest {
	...
	public static void main(String[] args) throws Exception {
		...
		// 准备加密业务数据
		String data = "{header:{osType:'ios'},data:{id:'402981e94ff2ef06014ff2f4b8aa0005'}}";
