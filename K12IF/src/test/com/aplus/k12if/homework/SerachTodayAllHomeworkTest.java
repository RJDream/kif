...
/**
 * ------------------------------------------------------------
 * <p>Title:@SerachTodayAllHomeworkTest.java </p>
 * <p>Description: 
 *    TODO 类功能描述
 * </p>
 ...
 * ------------------------------------------------------------
 */
public class SerachTodayAllHomeworkTest extends BaseInterfaceTest {
	...
	public static void main(String[] args) throws Exception {
		...
		// 准备加密业务数据
		String data = "{header:{osType:'ios'},data:{schoolId:'402981e84f1aac8c014f1aba4f1a0000',grade:'gr_01',gradeClass:'gc_03'}}";
