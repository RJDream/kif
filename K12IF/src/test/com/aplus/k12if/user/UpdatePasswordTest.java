...
/**
 * ------------------------------------------------------------
 * <p>Title:@UpdatePasswordTest.java </p>
 * <p>Description: 
 *    TODO 类功能描述
 * </p>
 ...
 * ------------------------------------------------------------
 */
public class UpdatePasswordTest extends BaseInterfaceTest {
	...
	public static void main(String[] args) throws Exception {
		UpdatePasswordTest t = new UpdatePasswordTest();
		// 准备加密业务数据
		String data = "{header:{osType:'ios'},data:{id:'1',oldPassword:'2',newPassword:'123'}}";
