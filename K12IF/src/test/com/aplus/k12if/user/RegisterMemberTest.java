...
public class RegisterMemberTest extends BaseInterfaceTest {
	...
	public void test() throws Exception {
		...
		// 准备加密业务数据
		String data = "{header:{osType:'ios'},data:{phone:'18877788874',password:'123456',code:'1111'}}";
