...
public class SerachRelStudentTest extends BaseInterfaceTest  {
	...
	public void testExecute() throws Exception {
		// 准备加密业务数据
		String data = "{header:{osType:'ios'},data:{memberId:'50ebe64d-3756-4651-b3b6-a98fe06dac2d'}}";
