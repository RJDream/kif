 ...
 *
 */
package test.com.aplus.k12if.safety;
...
/**
 * ------------------------------------------------------------
 * <p>Title:@SerachAllSafetyInfoTest.java </p>
 * <p>Description: 
 *    TODO 类功能描述
 * </p>
 ...
 * ------------------------------------------------------------
 */
public class SerachAllSafetyInfoTest extends BaseInterfaceTest {
	...
	public static void main(String[] args) throws Exception {
		SerachAllSafetyInfoTest t = new SerachAllSafetyInfoTest();
		// 准备加密业务数据
		String data = "{header:{osType:'ios'},data:{studentId:'402880e94f3fe9a0014f3fecd31a0004',number:'3',pager:{page:'1',pageRecorders:'5'}}}";
