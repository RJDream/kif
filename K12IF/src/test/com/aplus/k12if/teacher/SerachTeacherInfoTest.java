package test.com.aplus.k12if.teacher;
...
public class SerachTeacherInfoTest extends BaseInterfaceTest {
	...
	public void testExecute() throws Exception {
		// 准备加密业务数据
		String data = "{header:{osType:'ios'},data:{schoolId:'8a22a0f2506a9f7d01506aa1e3ce0000',grade:'gr_06',class:'gc_01'}}";
